    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <section class="col-lg-7 connectedSortable w-100">
          ...
          <div class="card">
            <img class="life_memberImages" src="../assets/image/img1.jpg" alt="">
          </div>
          <div class="button_action">
            <button class="btn_prev" onclick="lifeMemberCarousel()">
              < </button>
        ...
        <section class="col-lg-5">
          ...
          <div class="row excel-container" data-toggle="modal" data-target="#excelModal">
            <img class="col excel-img" src="../assets/image/excel.png">
          </div>
          <!-- Button trigger modal -->
          <!-- <button type="button" class="btn btn-primary" data-toggle="excelModal" data-target="#excelModal">
            Launch demo modal
          </button> -->
